...
def main():
    ...
    parser.add_argument("-d", "--work-dir", help="Working directory to clone repos", default=WORK_DIR)
    parser.add_argument("-s", "--source-pat", help="GitHub token for source org", default=SOURCE_PAT)
    parser.add_argument("-t", "--target-pat", help="GitHub token for target org", default=TARGET_PAT)
